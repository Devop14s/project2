...
Use [../infra-docs/README.md](</D:/App/project2/infra-docs/README.md>) when the remaining work is entirely infrastructure setup rather than repo or pipeline design.
