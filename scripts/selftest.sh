...
sh scripts/validate-service-mesh-docs.sh >/dev/null
...
grep -q 'mesh/peer-authentication.yaml' docs/service-mesh-test-plan.md
grep -q '<link to curl output or screenshot>' docs/service-mesh-results.md
