...
$requiredFiles = @(
    ...
    'scripts\validate-service-mesh-docs.ps1',
    'scripts\validate-service-mesh-docs.sh',
...
$validatorDefinitions = @(
    ...
    @{
        name = 'validate-service-mesh-docs'
        script = 'scripts\validate-service-mesh-docs.ps1'
        arguments = @()
    },
    @{
