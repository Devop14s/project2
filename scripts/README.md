...
In Jenkins, the top-level dispatcher can also create that `yas-source-upstream/` checkout on demand, so the source tree does not need to be committed into this delivery repo.
