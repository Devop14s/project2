...
$content.Add('- The full upstream-style integration path is still blocked for `cart`, `customer`, `location`, `promotion`, `tax`, and `webhook` because Keycloak Testcontainers does not become healthy reliably on this host.')
